  ...
  return (
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-125 max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Aggiorna il turno mantenendo la stessa struttura della creazione.
            </DialogDescription>
          </DialogHeader>
      ...
      <AlertDialog
        ...
        onOpenChange={(v) => {
          if (!v) setConfirmDeleteShift(false)
        }}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Stai per eliminare <span className="font-semibold">"{shift.title}"</span> del{' '}
              {shift.shift_date}. Questa azione non può essere annullata.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
